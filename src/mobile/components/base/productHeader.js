        ...
        <Navbar variant="dark" sticky="top" className="py-1 my-nav" >
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="align-items-center w-100">
                    <Nav.Link className="ms-auto pe-4 ps-1" onClick={() => setModalShow(true)}><img src={plusIcon} height="38px" alt="plus-icon" /></Nav.Link>    
                    <Navbar.Text className="fs-6 text-light">{title}</Navbar.Text>
                    <Nav.Link href="/dashboard" className="me-auto ps-4"><img src={backIcon} height="26px" alt="back-icon" /></Nav.Link>
                </Nav>
            </Navbar.Collapse>
        </Navbar>
        </>
