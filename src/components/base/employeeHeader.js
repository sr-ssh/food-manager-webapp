...
export const Header = ({title, backLink, setAddModalShow}) => {
    return(
        <>
        <Navbar variant="dark" sticky="top" className="py-2 my-nav" >
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="align-items-center w-100">
                    <Nav.Link className="ms-auto pe-4" onClick={() => setAddModalShow(true)}><img src={plusIcon} height="40px" alt="plus-icon"  /></Nav.Link>    
